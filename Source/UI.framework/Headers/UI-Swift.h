...
SWIFT_CLASS("_TtC2UI23ActivityIndicatorButton")
...
SWIFT_CLASS("_TtC2UI13LinkableLabel")
@interface LinkableLabel : UIView
...
@interface LinkableLabel (SWIFT_EXTENSION(UI)) <UITextViewDelegate>
...
SWIFT_CLASS("_TtC2UI11ShimmerView")
@interface ShimmerView : GradientView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC2UI16SketchShadowView")
@interface SketchShadowView : UIView
- (nonnull instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (void)layoutSubviews;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end
